...
const PasswordChange = (props:any) => {
  ...
  async function sendEmail(){
    ...
    const resObj = await transaction("post", "sendemailforpassword", obj, "", false, true, screenShow, errorShow);
  ...
  async function signUp(){
    ...
    if(!retObj.yn){
      ...
      const resObj = await transaction("post", "changepassword", obj, "", false, true, screenShow, errorShow);
          ...
          <div className={block +  "  w-[300px] h-[400px] border-2 rounded-md border-[#006341] shadow-lg shadow-green-900/50  bg-white"}>
            ...
            {(!signUpSeccess)?<>
              ...
              <div className=" flex justify-center w-[100%]">
                <p className=" text-sm leading-relaxed text-[#006341]">Go to Sign in page.
            ...
            :<>
              ...
              <div className=" ">
                <p className=" text-center text-2xl font-bold mt-2 text-[#006341]">
                  Password Change 
                </p> 
                <p className=" text-center text-2xl font-bold  text-[#006341]">
                  Success 
                </p> 
              </div>
