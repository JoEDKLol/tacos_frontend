...
////////////////////////////
  ...
  async function searchUserInfo(){
    ...
    if(retObj.sendObj.success==="y"){
      setUserimg(retObj.sendObj.resObj.userimg);
      setUserthumbImg(retObj.sendObj.resObj.userthumbImg);
      setUsername(retObj.sendObj.resObj.username);
    }
  }
            ...
            <div className="text-sm font-medium text-center w-[80%] text-gray-500 border-b border-[#006341] ">
              <ul className="flex flex-wrap -mb-px ">
                  <li className="me-3 ">
                      ...
                      className={tabLayOut1 + " inline-block p-3 border-transparent border-b-2  "}>Profile</a>
                  </li>
                  <li className="">
                      <a
                      onClick={()=>selectTabs(1)}
                      // className={"  text-blue-600 border-blue-600 rounded-t-lg active dark:text-blue-500"}>Restaurant</a>
                      className={tabLayOut2 + " inline-block p-3 border-transparent border-b-2 "}>Restaurant</a>
                  </li>
              ...
              <div className="flex flex-col w-[80%]">
              {
                ...
                ">  
                  ...
                  <div className="">
                    ...
                    <div className="flex justify-center mt-2">
                      <p className="w-[200px] justify-normal">
                      리뷰이동
                      </p>
                    </div>
                    <div className="flex justify-center mt-2">
